...
Implementation status: issues #9 and #10 implement exact released ScoreForm
v0.10.0 and Quillan v0.9.0 public readers. Both use lazy import, explicit registry
composition, exact-version rejection, and the accepted one-way dependency. This
clarification does not amend the decision.
...
- Issues #9 and #10 implement ScoreForm and Quillan against their accepted public
  contracts.
