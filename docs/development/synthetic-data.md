...
Meridian baseline fixtures may exercise Core envelopes and compatibility
metadata. Producer-manifest bodies and native producer semantics belong to the
producer repositories and later Meridian adapter issues.
