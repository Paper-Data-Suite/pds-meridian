"""Run issue #52's installed bounded-hybrid Grade acceptance."""
...
PROGRAM = Path(__file__).with_name("smoke_program_hybrid_grade.py")
RELOAD_PROGRAM = Path(__file__).with_name("smoke_program_hybrid_grade_reload.py")
...
def run_prepared_smoke(
    ...
    """Run hybrid-Grade acceptance in a prepared environment."""
...
def smoke_test(
    ...
    with tempfile.TemporaryDirectory(
        prefix="pds-meridian-hybrid-grade-smoke-"
    ) as raw_temp:
        root = Path(raw_temp)
