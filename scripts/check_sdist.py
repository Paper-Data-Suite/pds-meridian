...
REQUIRED_MEMBERS = frozenset(
    {
        ...
        "docs/architecture/grade-policy-models-storage-and-activation.md",
        ...
        "docs/architecture/reporting-exports.md",
        ...
        "docs/architecture/teacher-eligibility-proficiency-planning-workflows.md",
        "docs/architecture/proficiency-planning-export-explanation-traces.md",
        "docs/architecture/proficiency-attention-summaries.md",
        ...
        "scripts/installed_qualification_matrix.py",
        "scripts/installed_qualification_harness.py",
        "scripts/installed_qualification_core_programs.py",
        "scripts/installed_qualification_runner.py",
        "scripts/validate_repository.py",
        "tests/test_installed_qualification_matrix_issue96.py",
        "tests/test_installed_qualification_harness_issue96.py",
        ...
        "tests/test_installed_qualification_scoreform_quillan_issue96.py",
        "tests/test_installed_qualification_all_adapters_issue96.py",
        "tests/test_installed_qualification_hardening_issue96.py",
        ...
        "tests/test_grade_item_proficiency_explanation.py",
        "tests/test_grade_item_proficiency_explanation_provenance.py",
        "tests/test_grade_item_proficiency_authorized_detail.py",
        "tests/test_cli_grade_item_proficiency_explanation.py",
        "tests/test_academic_period_proficiency_explanation.py",
        "tests/test_cli_academic_period_proficiency_explanation.py",
        "tests/test_planning_signal_derivation_explanation.py",
        "tests/test_cli_planning_signal_derivation_explanation.py",
        "tests/test_planning_signal_preview_review_explanation.py",
        "tests/test_cli_planning_signal_preview_review_explanation.py",
        "tests/test_planning_signal_export_explanation.py",
        "tests/test_cli_planning_signal_export_explanation.py",
        "tests/test_issue42_packaging_acceptance.py",
        "tests/test_issue42_documentation_acceptance.py",
        ...
        "tests/test_issue43_installed_acceptance.py",
        "tests/test_issue43_documentation_acceptance.py",
        ...
        "tests/test_issue50_grade_policy_contract.py",
        "tests/test_conventional_grade.py",
        "tests/test_conventional_grade_assembly.py",
        "tests/test_conventional_grade_result.py",
        "tests/test_conventional_grade_storage.py",
        "tests/test_issue50_conventional_grade_documentation.py",
        "tests/test_issue50_conventional_grade_assembly_documentation.py",
        "tests/test_issue50_conventional_grade_result_documentation.py",
        ...
        "scripts/smoke_program_report_exports.py",
        "scripts/smoke_program_report_exports_reload.py",
        "tests/test_issue56_installed_acceptance.py",
        ...
        "tests/test_export_profile_issue56.py",
        "tests/test_export_profile_storage_issue56.py",
        "tests/test_report_export_roster_issue56.py",
        "tests/test_report_export_preview_issue56.py",
        "tests/test_report_export_receipt_issue56.py",
        "tests/test_report_export_commit_issue56.py",
        "tests/test_cli_report_exports_issue56.py",
        "tests/test_issue56_documentation_acceptance.py",
        "tests/test_issue56_packaging_acceptance.py",
